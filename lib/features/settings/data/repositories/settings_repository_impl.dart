  ...
  Future<void> setBudget(double budget) async {
    ...
    await db.upsertSettings(
      SettingsCompanion.insert(
        ...
        dailyReminderTime: Value(current?.dailyReminderTime ?? 1200),
        recurringBillRemindersEnabled: Value(current?.recurringBillRemindersEnabled ?? false),
        lendDueRemindersEnabled: Value(current?.lendDueRemindersEnabled ?? false),
        goalRemindersEnabled: Value(current?.goalRemindersEnabled ?? false),
  ...
  Future<void> setNotificationPreferences({
    ...
    await db.upsertSettings(
      SettingsCompanion.insert(
        ...
        dailyReminderTime: Value(dailyReminderTime ?? current?.dailyReminderTime ?? 1200),
        recurringBillRemindersEnabled: Value(recurringBillRemindersEnabled ?? current?.recurringBillRemindersEnabled ?? false),
        lendDueRemindersEnabled: Value(lendDueRemindersEnabled ?? current?.lendDueRemindersEnabled ?? false),
        goalRemindersEnabled: Value(goalRemindersEnabled ?? current?.goalRemindersEnabled ?? false),
        privacyLockEnabled: Value(current?.privacyLockEnabled ?? false),
        showAmountsEnabled: Value(current?.showAmountsEnabled ?? true),
        lastBudgetAlertAt: Value(current?.lastBudgetAlertAt),
        updatedAt: DateTime.now().millisecondsSinceEpoch,
