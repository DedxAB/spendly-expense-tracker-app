...
class SettingsEntity with _$SettingsEntity {
  const factory SettingsEntity({
    ...
    @Default(1200) int dailyReminderTime,
    @Default(false) bool recurringBillRemindersEnabled,
    @Default(false) bool lendDueRemindersEnabled,
    @Default(false) bool goalRemindersEnabled,
