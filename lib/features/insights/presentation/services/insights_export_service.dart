...
class InsightsExportService {
            ...
            pw.Column(
              ...
              children: [
                ...
                if (userName != null) ...[
                  ...
                  pw.Text(userName, style: subtitleStyle.copyWith(fontSize: AppFontSizes.label)),
                ],
              ],
            ),
            pw.Text(
  ...
  pw.Widget _summaryCard(
    ...
    return pw.Container(
      ...
      child: pw.Column(
        children: [
          pw.Text(label.toUpperCase(), style: bodyStyle.copyWith(fontSize: AppFontSizes.caption, color: PdfColors.grey600)),
