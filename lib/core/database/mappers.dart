...
SettingsCompanion settingsToCompanion(SettingsEntity entity) {
  return SettingsCompanion.insert(
    ...
    dailyReminderTime: Value(entity.dailyReminderTime),
    recurringBillRemindersEnabled: Value(entity.recurringBillRemindersEnabled),
    lendDueRemindersEnabled: Value(entity.lendDueRemindersEnabled),
    goalRemindersEnabled: Value(entity.goalRemindersEnabled),
...
LendEntriesCompanion lendEntryToCompanion(LendEntryEntity entity) {
  return LendEntriesCompanion.insert(
    ...
    amountPaise: Value(Money.toPaise(entity.amount)),
    date: entity.date.millisecondsSinceEpoch,
    dueDate: Value(entity.dueDate?.millisecondsSinceEpoch),
    note: Value(entity.note),
